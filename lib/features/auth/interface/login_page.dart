...
class _LoginPageState extends ConsumerState<LoginPage> {
  ...
  BoxDecoration loginPageContainerDecoration = BoxDecoration(
      image: DecorationImage(
          image: Image.network("https://storage.googleapis.com/flutterflow-io-6f20.appspot.com/projects/i-i-s-e-r-m-test-app-gct9v1/assets/n5vs1zgakg2k/image_2023-07-12_061133339.png").image,
          fit: BoxFit.cover,
      )
  );
